...
public static class ReflectionExtensions
{
  ...
  public static TDestination DownCastOrThrow<TSource, TDestination>(this TSource source) where TDestination : TSource
  {
    if (!(source is TDestination desination)) throw new ArgumentException($"Must be of {typeof(TDestination).Name}", nameof(source));
    return desination;
  }
}
