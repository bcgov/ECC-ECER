<template>
    ...
    <v-col cols="12">
      ...
      <div class="d-flex flex-column ga-3">
        ...
        <div>
          ...
          <ul class="ml-10">
            <li>
              Already have a recognized early childhood education basic program,
              or
            </li>
  ...
  <v-row>
    <v-col cols="12">
      ...
      <ul class="ml-10">
        <li>
          A first-time application for a basic ECE program is restricted to one
          campus
        </li>
        <li>
          A first-time application for a basic ECE or post-basic ECE program is
          restricted to one delivery mode (for example, as a first-time
          applicant, if you are applying for an in-person basic ECE program, you
          would not be eligible to concurrently apply for an online program)
        </li>
      </ul>
    </v-col>
  </v-row>
