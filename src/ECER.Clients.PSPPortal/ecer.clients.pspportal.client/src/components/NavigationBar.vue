  ...
  <v-app-bar height="80" elevation="0" border>
    <v-container>
      <v-row align="center">
        ...
        <template
          v-if="userStore.hasUserProfile && userStore.hasAcceptedTermsOfUse"
        >
          <v-menu
          ...
          >
            ...
            <v-list>
              ...
              <v-list-item link>
                <v-list-item-title>
                  <router-link class="small" to="/messages">
                    Messages
                  </router-link>
                </v-list-item-title>
              </v-list-item>
              ...
              <v-list-item link>
                <v-list-item-title>
                  <router-link class="small" to="/profile/edit">
                    My profile
                  </router-link>
                </v-list-item-title>
              </v-list-item>
              <v-list-item link>
                <v-list-item-title>
                  <p
                    class="small text-decoration-underline text-links"
