<template>
  <v-sheet :rounded="0" flat color="primary" width="100%">
    <PageContainer :margin-top="false" class="py-13">
      <h1 class="text-white">
        Welcome to the ECE Post-Secondary Programs Portal
      </h1>
      <p class="small text-white mt-4">
        For educational institutions to manage their ECE programs with the B.C.
        ECE Registry
      </p>
    </PageContainer>
  </v-sheet>
      ...
      <v-col cols="12" md="6" class="mb-12">
        <div class="d-flex flex-column ga-4">
          ...
          <p>
            ...
            <a
              href="https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/96165_00"
            >
