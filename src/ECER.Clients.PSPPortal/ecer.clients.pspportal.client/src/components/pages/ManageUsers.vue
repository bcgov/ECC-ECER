<template>
    <PageContainer>
                ...
                <v-sheet color="support-surface-info " class="w-100 px-12 py-7">
                    <div class="d-flex flex-column ga-3 text-support-border-info">
                        ...
                        <ol class="ml-8">
                            ...
                            <li>Will require a Business BCeID account granted from your institution in order to login.
                            </li>
                        </ol>
        ...
        <v-row>
            <v-col cols="12">
                <div class="d-flex flex-column ga-3">
                    <p>The Primary contact is the person that the ECE Registry would contact first, if there is a reason
                        to do so.
                    </p>
                    <p>
                    <ul class="ml-8">
                        <li>Setting a user as the Primary contact user does not apply any additional permissions to the
                            user
                            in
                            this portal.</li>
        ...
        <v-row>
            <v-col cols="12">
                TODO: Add table of invitations pending
            </v-col>
        </v-row>
        <v-row>
            <v-col cols="12">
        ...
        <v-row>
            <v-col cols="12">
                TODO: Add table of inactive users
            </v-col>
        </v-row>
    </PageContainer>
</template>
...
export default defineComponent({
    name: "ManageUsers",
    components: { PageContainer, Breadcrumb, ECEHeader },
    props: {
