  ...
  <PageContainer>
    ...
    <v-row>
      <v-col cols="12">
        ...
        <div class="d-flex flex-column ga-3">
          <p>
            Under the authority of the Community Care and Assisted Living Act
            and the Child Care Licensing Regulation (CCLR), the Director of the
            Early Childhood Educator Registry (Registry) sets standards for the
            certification of Early Childhood Educators (ECEs) in British
            Columbia. Recognized early childhood education programs are listed
            in Schedule D of the CCLR and have been evaluated and found to
            provide students with the knowledge, skills, and abilities required
            to meet this standard.
          </p>
          <p>
            This application solicits information to assess early childhood
            education programs against the standards as established in
            regulation, the
            <a
          ...
          <div>
            <p>
              ...
              [ITE] and/or Special Needs Educator [SNE]), an institution must
              either:
            </p>
            <ul class="ml-10">
              <li>
                Already have a recognized early childhood education basic
                program, or
              </li>
              <li>
    ...
    <v-row>
      <v-col cols="12">
        ...
        <ul class="ml-10">
          <li>
            A first-time application for a basic ECE program is restricted to
            one campus
          </li>
          <li>
            A first-time application for a basic ECE or post-basic ECE program
            is restricted to one delivery mode (for example, as a first-time
            applicant, if you are applying for an in-person basic ECE program,
            you would not be eligible to concurrently apply for an online
            program)
          </li>
        </ul>
      </v-col>
      ...
      <v-col cols="12">
        ...
        <div class="d-flex flex-column ga-3 mt-4">
          ...
          <div>
            ...
            <ul class="ml-10">
              <li>
                As your application will take some time to complete, you may
                save and exit at any point in the form to resume editing later
              </li>
              <li>You may complete the sections in any order</li>
              <li>
                You will be asked to review and make any edits to your responses
                prior to submitting your application to the ECE Registry
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul class="ml-10">
              ...
              <li>
                Clear, concise documentation is required for each component
              </li>
              <li>
    ...
    <v-row>
      <v-col cols="12">
        ...
        <div class="d-flex flex-column ga-3 mt-4">
          <p>
            The Registry can begin your assessment after you submit your
            completed application package.
          </p>
          <p>
            Site visits may be required during the assessment to determine
            interim recognition and ongoing recognition.
          </p>
          <p>
            As early childhood education continues to grow and evolve, any
            program recognized under current competencies or standards will be
            required to upgrade if new standards are adopted. Recognized
            programs are subject to review.
          </p>
        </div>
      </v-col>
    </v-row>
...
export default defineComponent({
  ...
  components: { ECEHeader, Callout, PageContainer },
});
</script>
