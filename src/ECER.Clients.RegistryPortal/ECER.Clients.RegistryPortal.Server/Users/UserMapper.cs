...
internal sealed class UserMapper : AutoMapper.Profile
{
  public UserMapper()
  {
    CreateMap<UserInfo, Managers.Registry.Contract.Registrants.UserProfile>()
      ...
      .ForCtorParam(nameof(Managers.Registry.Contract.Registrants.UserProfile.MiddleName), opts => opts.MapFrom(s => s.MiddleName))
      .ForCtorParam(nameof(Managers.Registry.Contract.Registrants.UserProfile.AlternateContactPhone), opts => opts.MapFrom(s => s.AlternateContactPhone))
      .ForCtorParam(nameof(Managers.Registry.Contract.Registrants.UserProfile.PreferredName), opts => opts.MapFrom(s => s.PreferredName))
