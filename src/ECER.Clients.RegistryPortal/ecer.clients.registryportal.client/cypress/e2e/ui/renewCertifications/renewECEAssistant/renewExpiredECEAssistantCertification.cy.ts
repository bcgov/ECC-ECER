...
describe("Renew Expired ECE Assistant Certificate Application", () => {
  it("should create a sucessfull Renewal - ECE Assistant Application", () => {
    cy.seedRenewalApplication("ECEAssistant", false, false);
