...
const certificationName = "Level 2 or Level 3";

describe("Labour Mobility - Level 2 or Level 3 Certification Transfer Application for Nova Scotia", () => {
  it("should sucessfully create a Level 2 or Level 3 LM Certification Transfer Application for Nova Scotia", () => {
    /** Dashboard */
