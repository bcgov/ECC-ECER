...
const certificationName = "ECE II";

describe("Labour Mobility - ECE II Certification Transfer Application for Saskatchewan", () => {
  it("should sucessfully create a ECE II LM Certification Transfer Application for Saskatchewan", () => {
    /** Dashboard */
