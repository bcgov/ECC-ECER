...
export const useLookupCertificationStore = defineStore("lookupCertification", {
  ...
  getters: {},
  actions: {
    setCertificationSearchResults(
      data: Components.Schemas.CertificationLookupResponse[] | undefined,
    ): void {
      this.certificationSearchResults = data;
    },
    setCertificationRecord(
      record: Components.Schemas.CertificationLookupResponse,
    ): void {
      this.certificationRecord = record;
    },
    generateCertificateLevelName(
      levels: Components.Schemas.CertificationLevel[],
    ) {
      ...
      console.warn(
        `generateCertificateLevelName:: unmapped level type:: ${levels}`,
      );
      return "";
    },
  },
