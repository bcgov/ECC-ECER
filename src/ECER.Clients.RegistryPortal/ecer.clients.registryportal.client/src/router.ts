...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/manage-application/:applicationId/transcript/:transcriptId",
      name: "viewTranscriptDetails",
      component: () => import("./components/ViewTranscriptDetails.vue"),
      meta: { requiresAuth: true, requiresVerification: true },
      props: true,
    },
    {
      path: "/manage-application/:applicationId/transcript/:transcriptId/course-outline",
      name: "viewCourseOutline",
      component: () => import("./components/ViewCourseOutline.vue"),
      meta: { requiresAuth: true, requiresVerification: true },
      props: true,
    },
    {
      path: "/manage-application/:applicationId/transcript/:transcriptId/program-confirmation",
      name: "viewProgramConfirmation",
      component: () => import("./components/ViewProgramConfirmationForm.vue"),
      meta: { requiresAuth: true, requiresVerification: true },
      props: true,
    },
    {
      path: "/manage-application/:applicationId/transcript/:transcriptId/comprehensive-evaluation",
      name: "viewComprehensiveReport",
      component: () => import("./components/ViewComprehensiveReport.vue"),
      meta: { requiresAuth: true, requiresVerification: true },
      props: true,
    },
    {
