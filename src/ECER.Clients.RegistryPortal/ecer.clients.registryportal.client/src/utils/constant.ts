...
export const fiveYearRenewalInformationRadio: RadioButtonWrapper<Components.Schemas.OneYearRenewalexplanations>[] = [
...
export const renewalInformationRadio: RadioButtonWrapper<Components.Schemas.FiveYearRenewalExplanations>[] = [
