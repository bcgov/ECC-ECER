...
const getApplications = async (
  ...
  ApiResponse<Components.Schemas.Application[] | null | undefined>
> => {
  const client = await getClient();

  return apiResultHandler.execute<
    Components.Schemas.Application[] | null | undefined
  >({ request: client.application_get({ id: id }), key: "application_get" });
};

const createOrUpdateDraftApplication = async (
  application: Components.Schemas.DraftApplication,
): Promise<
  ApiResponse<Components.Schemas.DraftApplicationResponse | null | undefined>
> => {
  const client = await getClient();
...
const submitDraftApplication = async (
  ...
  ApiResponse<Components.Schemas.SubmitApplicationResponse | null | undefined>
> => {
  const client = await getClient();
...
const cancelDraftApplication = async (
  applicationId: string,
): Promise<
  ApiResponse<
    Components.Schemas.CancelDraftApplicationResponse | null | undefined
  >
> => {
  const client = await getClient();
...
const getApplicationStatus = async (
  ...
  ApiResponse<Components.Schemas.SubmittedApplicationStatus | null | undefined>
> => {
  const client = await getClient();
  const pathParameters = {
    id: applicationId,
  ...
  return await apiResultHandler.execute<
    Components.Schemas.SubmittedApplicationStatus | null | undefined
  >({
...
const setTranscriptDocumentsAndOptions = async (
  body: Paths.ApplicationUpdateTranscriptPost.RequestBody,
): Promise<ApiResponse<any>> => {
  const client = await getClient();
  return apiResultHandler.execute({
