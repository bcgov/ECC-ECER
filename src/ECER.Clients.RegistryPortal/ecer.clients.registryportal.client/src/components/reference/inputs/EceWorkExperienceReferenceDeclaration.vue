      ...
      <v-row no-gutters>
        <v-col>
          ...
          >
            ...
            <li>
              An assessment if you think the applicant is competent in a variety
              of areas - if not, we'll ask you to provide more details
            </li>
            <li>
              Total number of hours you directly supervised the applicant
              working
            </li>
          ...
          >
            ...
            <ul class="ml-10">
              <li>
                Have directly supervised (observed) all hours during which the
                applicant worked or volunteered
              </li>
              <li>
                Have held a valid Canadian ECE certification/registration during
                the hours you supervised the applicant
              </li>
              <li>
                Be able to speak to the applicant's knowledge, skills, and
                ability (competencies) as an ECE
              </li>
            </ul>
          </div>
          <div
          ...
          >
            ...
            <ul class="ml-10">
              <li>
                Able to confirm the applicant completed work experience hours
              </li>
              <li>
                A co-worker, supervisor, or parent/guardian of a child you cared
                for
              </li>
            </ul>
          </div>
