<template>
  <v-container>
    ...
    <div class="d-flex flex-column ga-3 mb-10">
      ...
      <h2>
        {{ totalRequiredWorkExperienceHours }} hours of work experience is
        required.
      </h2>
      <p>Your hours:</p>
      <ul class="ml-10">
      ...
      <p>
        If you worked at multiple locations, add a reference for each location.
      </p>
    </div>
    <div
      v-for="(
        reference, index
      ) in applicationStatus?.workExperienceReferencesStatus"
      :key="index"
    >
    ...
    <div v-if="totalHours < totalRequiredWorkExperienceHours" class="mt-10">
      <p>
        You need {{ totalRequiredWorkExperienceHours - totalHours }} more hours
        of work experience.
      </p>
      <v-btn
    ...
    <Callout
      v-if="
        totalHours >= totalRequiredWorkExperienceHours &&
      ...
      class="mt-10"
    >
      No additional work references needed. You’ve provided the required hours.
      We will contact you shortly. We’re either waiting on a response from your
    ...
    >
      No additional work references needed. You’ve provided the required hours.
      We’re waiting on a response from your one or more of your references.
    </Callout>
    <div class="mt-10">
      <a
        href="#"
...
export default defineComponent({
  ...
  computed: {
    ...
    totalRequiredWorkExperienceHours(): number {
      return this.applicationStatus?.workExperienceReferencesStatus?.every(
