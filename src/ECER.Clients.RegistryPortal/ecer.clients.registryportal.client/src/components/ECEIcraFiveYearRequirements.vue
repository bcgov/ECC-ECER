<template>
  <v-row>
    <v-col cols>
      <h1 class="title-header">
        Apply for ECE Five Year, Infant and Toddler Educator, and Special Needs
  ...
  <v-row>
    <v-col>
      <ECEHeader title="Competencies assessment"></ECEHeader>
      <p>
        The employment experience reference(s) provided during the eligibility
        submission will be asked to complete a competencies assessment to verify
        that you have the knowledge, skills and abilities to work as an ECE in
        British Columbia. They will be sent a link to an online form once you
...
export default defineComponent({
  name: "ECEIcraFiveYearRequirements",
