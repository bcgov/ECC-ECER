<template>
  <v-col cols="12">
    <h1>Renew your ECE Assistant certification</h1>
  </v-col>
  <v-col cols="12">
  ...
  <v-col cols="12">
    ...
    <div class="d-flex flex-column ga-3 my-6">
      <p>
        You must have successfully completed one additional early childhood
        education course. The course must:
      </p>
      <ul class="ml-10">
        <li>Have been completed within the last 5 years</li>
        <li>
          Be a different course than the one you previously used for ECE
          Assistant certification
        </li>
        <li>
          Be part of a basic early childhood education
          <a
            href="https://www2.gov.bc.ca/gov/content?id=62102395C4F64F068A63E42921E67720"
          >
      ...
      <p>
        You'll need to request an official transcript from your educational
        institution. It'll need to be sent directly to the ECE Registry from the
  ...
  <v-col cols="12">
    ...
    <div class="d-flex flex-column ga-3 my-6">
      ...
      <ul class="ml-10">
        ...
        <li>Have been completed within the last five years</li>
      </ul>
...
export default defineComponent({
  name: "ECEAssistantRenewalRequirements",
