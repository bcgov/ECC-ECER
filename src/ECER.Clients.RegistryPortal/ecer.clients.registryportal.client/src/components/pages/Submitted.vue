<template>
    ...
    <v-container>
      <div class="d-flex">
        <v-icon
          ...
          class="mr-2"
        ></v-icon>
        <h1 id="titleApplicationSubmitted" class="align-self-center">
  ...
  <PageContainer>
    ...
    <p>
      It is important to keep your contact information up-to-date in your My ECE
      Registry profile.
    </p>
    <br />
    <div v-if="applicationHasTranscripts">
      ...
      <ul class="ml-10">
        <li>
          <strong>
            Make sure the ECE Registry will receive your transcripts in English
          </strong>
        </li>
    ...
    <br />
    <div
      v-if="applicationHasTranscripts && applicationHasEducationNotRecognized"
    >
      ...
      <ul class="ml-10">
        <li>
          <strong>
            Your application summary lists the supporting documents you need to
            submit as your educational institution is not recognized by the ECE
            Registry
          </strong>
        </li>
        <li>
          Once submitted, we will review these documents to determine whether
          the {{ applicationIsEceAssistant ? "course" : "program" }} is
    ...
    <ul class="ml-10">
      <li>
        We have emailed the people you identified as a reference with a link to
        an online form
      </li>
      <li>
        Your reference must complete the online form to provide a reference for
        you
      </li>
    ...
    <br />
    <ul class="ml-10">
      <li v-if="applicationHasTranscripts">
        We will assess your application after we have received your transcripts
        and references
      </li>
      <li v-else>
        We will assess your application after we have received your references
      </li>
    ...
    <ul class="ml-10">
      <li>
        You may view the status of your application online in the My ECE
        Registry
      </li>
      <li>
        If needed, you can resend a link to your reference or manage your
        references
      </li>
    </ul>
    <br />
...
export default defineComponent({
  ...
  computed: {
    ...
    applicationIsEceAssistant() {
      return this.applicationStore.application?.certificationTypes?.includes(
        "EceAssistant",
      );
    },
    certificationText() {
