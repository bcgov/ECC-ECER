<template>
  <div>
    ...
    <p class="mt-6">
      To work as an Early Childhood Educator (ECE) or ECE Assistant in a licensed child care facility in B.C. you must be certified by the ECE Registry. Log in
      to manage your certifications, review your eligibility, and access your messages.
    </p>
      ...
      <div class="d-flex flex-row flex-wrap justify-center ga-16">
        <LoginCard is-preferred>
          <div class="d-flex flex-column ga-8 align-center justify-center fill-height">
            ...
            <div class="d-flex flex-column ga-2" :style="{ height: '120px' }">
        ...
        <LoginCard>
          <div class="d-flex flex-column ga-8 align-center justify-center fill-height">
            ...
            <div class="mx-10" :style="{ height: '120px' }">
              <p class="small">
