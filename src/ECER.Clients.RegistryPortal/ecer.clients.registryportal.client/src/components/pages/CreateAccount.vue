    ...
    <v-row class="mt-8">
      <v-col cols="12" md="4">
        <IconCard
          title="Step 1"
          icon="mdi-lock-open"
          text="Log in securely with BC Services Card or another login option."
        />
      </v-col>
      <v-col cols="12" md="4">
        <IconCard
          ...
          text="Add your contact information to complete your My ECE Registry account."
        />
      </v-col>
      <v-col cols="12" md="4">
        <IconCard
          ...
          text="Submit a new application or access your existing certifications."
        />
      </v-col>
    </v-row>
    <div class="mt-12">
      ...
      >
        ...
        <v-expansion-panel-text>
          ...
          <div class="d-flex flex-column ga-4">
            ...
            <ul class="ml-10">
              <li>
                Is a secure login service provided by the Government of British
                Columbia
              </li>
              <li>
                Allows you to log in to My ECE Registry and many other
                government services
              </li>
            ...
            <p>
              <a
                href="https://id.gov.bc.ca/account/setup-instruction"
                target="_blank"
              >
                How to set up a BC Services Card account
              </a>
            </p>
          </div>
        </v-expansion-panel-text>
        ...
        <v-expansion-panel-text>
          <div class="d-flex flex-column ga-4">
            <p>
              You can use
              <b>Basic BCeID</b>
              to log in when you cannot use BC Services Card (for example, if
              you only have ID that was issued outside of Canada).
            </p>
            ...
            <Callout type="warning">
              <div class="d-flex flex-column ga-3 mt-3">
                ...
                <p>
                  ...
                  after you create a My ECE Registry account with your Basic
                  BCeID.
                </p>
              </div>
            </Callout>
            <Callout type="warning">
              <div class="d-flex flex-column ga-3 mt-3">
                ...
                <p>
                  Processing time is approximately 3-5 business days as we
                  review the ID to verify your identity.
                </p>
              </div>
            </Callout>
          </div>
          <v-btn
            @click="handleLogin('bceid')"
            class="my-8"
            :size="smAndDown ? 'default' : 'large'"
            color="primary"
            append-icon="mdi-arrow-right"
...
export default defineComponent({
  ...
  methods: {
    async handleLogin(provider: string) {
      ...
      await this.oidcStore.login(
        provider == "bceid" ? "bceidbasic" : "bcsc",
        redirectTo,
      );
    },
  },
