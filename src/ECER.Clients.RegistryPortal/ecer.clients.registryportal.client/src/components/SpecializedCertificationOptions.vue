<template>
  ...
  <div class="d-flex flex-column ga-3 my-6">
    <template v-if="!isLaborMobility">
      <p>
        There are 2 types of specialized certifications in B.C. that you can add
        to your ECE Five Year certificate.
      </p>
      <ol class="ml-10">
        <li>
          Infant and Toddler Educator (ITE) - you must have completed an infant
          and toddler educator program
        </li>
        <li>
          Special Needs Educator (SNE) - you must have completed a special needs
          educator program
        </li>
      </ol>
    ...
    <template v-if="isLaborMobility">
      <p>
        You are also eligible to apply for the following specialized
        certificates as part of your out-of-province transfer application:
      </p>
      <ol class="ml-10">
        <li>Infant and Toddler Educator (ITE)</li>
        <ul class="bullet-list ml-10">
          <li>
            allows you to work alone and/or as the primary educator with
      ...
      <p class="mt-6">
        Please confirm the specialized certificates you want to add to your ECE
        Five Year:
      </p>
    </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleSpecializationSelection = inject<
      (newValue: Components.Schemas.CertificationType[]) => void
