...
namespace ECER.Utilities.DataverseSdk.Model
{
	...
	public partial class ecer_PreviousAddress : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// Available fields, at the time of codegen, for the ecer_previousaddress entity
		/// </summary>
		...
		public const string PrimaryIdAttribute = "ecer_previousaddressid";
		
		public const string PrimaryNameAttribute = "ecer_name";
		
		public const string EntitySchemaName = "ecer_PreviousAddress";
		
		public const string EntityLogicalName = "ecer_previousaddress";
		
		public const string EntityLogicalCollectionName = "ecer_previousaddresses";
		
		public const string EntitySetName = "ecer_previousaddresses";
		...
		public virtual ecer_AddressTypes? ecer_AddressType
		{
			...
			set
			{
				this.SetAttributeValue("ecer_addresstype", value.HasValue ? new Microsoft.Xrm.Sdk.OptionSetValue((int)value) : null);
			}
		}
		...
		public string ecer_addresstypeName
		{
			...
			get
			{
				if (this.FormattedValues.Contains("ecer_addresstype"))
				{
					return this.FormattedValues["ecer_addresstype"];
				}
				else
				{
					return default(string);
		...
		public System.Nullable<System.Guid> ecer_PreviousAddressId
		{
			...
			get
			{
				return this.GetAttributeValue<System.Nullable<System.Guid>>("ecer_previousaddressid");
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
				this.SetAttributeValue("ecer_previousaddressid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
		...
		/// <summary>
		/// N:1 ecer_contact_ecer_previousaddress_251
		/// </summary>
		[Microsoft.Xrm.Sdk.AttributeLogicalNameAttribute("ecer_customerid")]
		...
		public ECER.Utilities.DataverseSdk.Model.Contact ecer_contact_ecer_previousaddress_251
		{
			...
			get
			{
				return this.GetRelatedEntity<ECER.Utilities.DataverseSdk.Model.Contact>("ecer_contact_ecer_previousaddress_251", null);
			}
			[System.Diagnostics.DebuggerNonUserCode()]
			set
			{
            ...
            foreach (var p in anonymousType.GetType().GetProperties())
            {
                ...
                switch (name)
                {
                    case "id":
                        ...
                        Attributes["ecer_previousaddressid"] = base.Id;
                        break;
                    case "ecer_previousaddressid":
