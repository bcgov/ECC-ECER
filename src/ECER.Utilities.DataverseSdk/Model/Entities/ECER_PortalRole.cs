...
namespace ECER.Utilities.DataverseSdk.Model
{
	...
	public partial class ecer_PortalRole : Microsoft.Xrm.Sdk.Entity
	{
		...
		/// <summary>
		/// Available fields, at the time of codegen, for the ecer_portalrole entity
		/// </summary>
		...
		public const string PrimaryIdAttribute = "ecer_portalroleid";
		
		public const string PrimaryNameAttribute = "ecer_name";
		
		public const string EntitySchemaName = "ecer_PortalRole";
		
		public const string EntityLogicalName = "ecer_portalrole";
		
		public const string EntityLogicalCollectionName = "ecer_portalroles";
		
		public const string EntitySetName = "ecer_portalroles";
		...
		public System.Nullable<System.Guid> ecer_PortalRoleId
		{
			...
			set
			{
				this.SetAttributeValue("ecer_portalroleid", value);
				if (value.HasValue)
				{
					base.Id = value.Value;
				}
            ...
            foreach (var p in anonymousType.GetType().GetProperties())
            {
                ...
                switch (name)
                {
                    case "id":
                        ...
                        Attributes["ecer_portalroleid"] = base.Id;
                        break;
                    case "ecer_portalroleid":
