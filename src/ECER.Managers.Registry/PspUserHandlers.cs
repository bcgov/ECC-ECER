...
public class PspUserHandlers
{
  ...
  public async Task<string> Handle(RegisterPspUserCommand request, CancellationToken cancellationToken)
  {
    ...
    // Check if institution has business bceid ID
    
    // If no business bceid, set the business bceid to request context
    
    // If it does have a business bceid, check that the users requested bceid matches
