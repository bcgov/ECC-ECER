...
public class Configurer : IConfigureComponents
{
  public void Configure([NotNull] ConfigurationContext configurationContext)
  {
    ...
    configurationContext.Services.AddTransient<IInvestigationReconsiderationMapper, InvestigationReconsiderationMapper>();
    ...
    configurationContext.Services.AddTransient<InvestigationReconsiderationHandlers>();
