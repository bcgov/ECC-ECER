...
public class ProgramApplicationHandlerTest
{
  ...
  public async Task Handle_CreateProgramApplicationCommand_CreatesAndReturnsApplication()
  {
    ...
    var handler = new ProgramApplicationHandler(_repositoryMock.Object, _metadataRepositoryMock.Object, _courseRepositoryMock.Object, _validationEngineMock.Object, _mapperMock.Object, _mediatorMock.Object);
