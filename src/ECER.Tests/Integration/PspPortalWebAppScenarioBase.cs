...
public class PspPortalWebAppFixture : WebAppFixtureBase
{
  ...
  private async Task InitializeDataverseTestData(EcerContext context)
  {
    ...
    programApplication =
      GetOrAddProgramApplication(context, testPostSecondaryInstitute, ecer_PSIApplicationType.PostBasicProgramPublicPrivateContinuingEd, ecer_PostSecondaryInstituteProgramApplicaiton_StatusCode.RFAI);
  ...
  private ecer_PostSecondaryInstituteProgramApplicaiton GetOrAddProgramApplication(EcerContext context, ecer_PostSecondaryInstitute institute, ecer_PSIApplicationType type, ecer_PostSecondaryInstituteProgramApplicaiton_StatusCode statusCode)
  {
    var programName = $"Test_psp_program_application_{type}_{statusCode}";
