...
let clientArray = [
  ...
  },
  {
    ...
    redirectUris: [
      ...
      "https://dev-ecer-registry-portal.apps.silver.devops.gov.bc.ca/logout-callback",
      "http://localhost:5121/*",
      "https://efxdev-ecer-registry-portal.apps.silver.devops.gov.bc.ca",
      "https://efxdev-ecer-registry-portal.apps.silver.devops.gov.bc.ca/logout-callback",
    ],
    webOrigins: ["+"],
    notBefore: 0,
    bearerOnly: false,
  ...
  },
  {
    ...
    protocolMappers: [
      ...
      },
      {
        ...
        consentRequired: false,
        config: {
          "included.client.audience": "childcare-ecer-psp-dev",
          "introspection.token.claim": "true",
          "included.custom.audience": "aud",
          "userinfo.token.claim": "false",
          "id.token.claim": "false",
